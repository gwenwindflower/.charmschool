...
> [!IMPORTANT]
> I've migrated my dotfiles to chezmoi! It's just much easier to manage flipping between macOS and Linux VMs with a more robust system, particularly chezmoi's support for one-liner script provisioning, encrypted secrets, and password manager integration. This repo will no longer be receiving updates, but you're welcome to check out [my new dotfiles](https://github.com/gwenwindflower/dotfiles)!
